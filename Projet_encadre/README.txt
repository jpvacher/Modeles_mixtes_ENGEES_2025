...
2. Existe-t-il une saisonnalité dans la fréquence du Triton crêté dans les mares ? On s'attend à plus de tritons en début de saison de reproduction qu'en fin de saison de reproduction.
...
- Le script est donné pour commencer à explorer et mettre en forme les données. Il reste encore des choses à faire (exploration graphique, nouvelles variables, transformations…).
